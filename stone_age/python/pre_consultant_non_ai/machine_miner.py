...
def main():
    ...
    parser.add_argument('--username', required=True, help='WorldQuant username')
    parser.add_argument('--password', required=True, help='WorldQuant password')
    ...
    miner = MachineMiner(args.username, args.password)
